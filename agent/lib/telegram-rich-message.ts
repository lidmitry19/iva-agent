...
//     в порядке документа, каждое медиа любой вложенности — в `media`.
...
export interface RichMessageReading {
  /** Текст в порядке документа. Пустая строка, когда текста в сообщении нет. */
  readonly text: string;
  /** Медиа любой вложенности в порядке документа; фото — самый крупный размер. */
...
// фото, затем голосовая заметка, затем остальные ключи из telegram-parts.
