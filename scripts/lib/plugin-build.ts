...
/** The generated mount: what makes eve load the plugin's extension. */
export function mountSource(plugin: CodePlugin): string {
  return `// Generated by Iva from data/custom/plugins/${plugin.name} - do not edit.
// Every version build writes this file again (ADR-0009). The config is read at load
// time from data/custom/plugins/${plugin.name}.config.json, never baked in here.
import extension from "../../${plugin.directory}/${CODE_DIR}";
import { readPluginConfig } from "../lib/plugin-config.ts";
