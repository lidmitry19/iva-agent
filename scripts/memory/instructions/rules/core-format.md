...
1. **Char cap ≈ 3600** (~1000 tokens). On overflow → **condense, never grow**: merge, shorten,
...
| Standing preferences (tone, format, delivery)               | Project details/architecture → `cards/projects/` |
